...
#define SOI_OFFSET				0
#define SOI_LEN					2
const unsigned char JPEG_SOI[SOI_LEN] = {
	0xff, 0xd8};

#define jpeg_set_soi(ptr) \
	memcpy((unsigned char *)(ptr) + SOI_OFFSET, JPEG_SOI, SOI_LEN)

#define DQT_OFFSET				(SOI_OFFSET+SOI_LEN)
#define DQT_LEN					138
const unsigned char JPEG_DQT[DQT_LEN] = {
...
#define jpeg_set_dqt(ptr) \
	memcpy((unsigned char *)(ptr) + DQT_OFFSET, JPEG_DQT, DQT_LEN)

#define DHT_OFFSET				(DQT_OFFSET+DQT_LEN)
#define DHT_LEN					420
const unsigned char JPEG_DHT[DHT_LEN] = {
	0xff,0xc4,0x01,0xa2,0x00,0x00,0x01,0x05,
	0x01,0x01,0x01,0x01,0x01,0x01,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x02,
	0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0a,
	0x0b,0x10,0x00,0x02,0x01,0x03,0x03,0x02,
	...
	0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x02,
	0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0a,
	0x0b,0x11,0x00,0x02,0x01,0x02,0x04,0x04,
...
#define jpeg_set_dht(ptr) \
	memcpy((unsigned char *)(ptr) + DHT_OFFSET, JPEG_DHT, DHT_LEN)

#define SOF_OFFSET				(DHT_OFFSET+DHT_LEN)
#define SOF_LEN					19
const unsigned char JPEG_SOF[SOF_LEN] = {
	0xff,0xc0,0x00,0x11,0x08,0x00,0xf0,0x02,
	0xc0,0x03,0x01,0x22,0x00,0x02,0x11,0x01,
	0x03,0x11,0x01};

static inline void jpeg_set_sof(unsigned char *ptr, unsigned int width,
				unsigned int height)
{
	memcpy(ptr + SOF_OFFSET, JPEG_SOF, SOF_LEN);
	ptr[SOF_OFFSET + 5] = 0xff & (height>>8);
	ptr[SOF_OFFSET + 6] = 0xff & (height>>0);
	ptr[SOF_OFFSET + 7] = 0xff & (width>>8);
	ptr[SOF_OFFSET + 8] = 0xff & (width>>0);
}

#define SOS_OFFSET				(SOF_OFFSET+SOF_LEN)
#define SOS_LEN					14
const unsigned char JPEG_SOS[SOS_LEN] = {
	0xff,0xda,0x00,0x0c,0x03,0x01,0x00,0x02,
	0x11,0x03,0x11,0x00,0x3f,0x00};
#define jpeg_set_sos(ptr) \
	memcpy((unsigned char *)(ptr) + SOS_OFFSET, JPEG_SOS, SOS_LEN)

static inline void jpeg_set_header(unsigned char *ptr, unsigned int width,
				   unsigned int height)
{
	jpeg_set_soi(ptr);
	jpeg_set_dqt(ptr);
	jpeg_set_dht(ptr);
	jpeg_set_sof(ptr, width, height);
	jpeg_set_sos(ptr);
}
