...
static u8 tbl_ntsc_tw2865_common[] = {
	...
	0x12, 0xff, 0x09, 0xd0, 0x00, 0x00, 0x00, 0x7f,
	0x00, 0xd4, 0x70, 0x48, 0x80, 0x80, 0x00, 0x02, // 0x30
	0x12, 0xff, 0x09, 0xd0, 0x00, 0x00, 0x00, 0x7f,
...
static u8 tbl_pal_tw2865_common[] = {
	0x00, 0xd4, 0x70, 0x30, 0x80, 0x80, 0x00, 0x12, // 0x00
	0x11, 0xff, 0x01, 0xc3, 0x00, 0x00, 0x01, 0x7f,
	0x00, 0xd4, 0x70, 0x30, 0x80, 0x80, 0x00, 0x12, // 0x10
	0x11, 0xff, 0x01, 0xc3, 0x00, 0x00, 0x01, 0x7f,
	0x00, 0xd4, 0x70, 0x30, 0x80, 0x80, 0x00, 0x12, // 0x20
	0x11, 0xff, 0x01, 0xc3, 0x00, 0x00, 0x01, 0x7f,
	0x00, 0xd4, 0x70, 0x30, 0x80, 0x80, 0x00, 0x12, // 0x30
	0x11, 0xff, 0x01, 0xc3, 0x00, 0x00, 0x01, 0x7f,
	0x00, 0x94, 0x90, 0x48, 0x00, 0x38, 0x7F, 0x80, // 0x40
	0x80, 0x80, 0x77, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x50
	0x45, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x15, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x60
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x21, 0x43,
	0x08, 0x00, 0x00, 0x01, 0xf1, 0x03, 0xEF, 0x03, // 0x70
...
static int tw2865_setup(struct solo6010_dev *solo_dev, u8 dev_addr)
{
	...
	for (i = 0; i <= 0xff; i++) {
		...
		if ((i >= 0xb8 && i <= 0xc1 ) || (i >= 0xc4 && i <= 0xc7))
			continue;
		if ((i & 0x30) == 0x00 ||
		    (i & 0x30) == 0x0c ||
		    (i & 0x30) == 0x0d)
