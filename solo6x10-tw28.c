...
static void saa712x_setup(struct solo_dev *dev)
{
	...
	/* :0x50 */
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x67, 0x76, 0xa5, 0x2a, 0x2e, 0x2e,
	/* :0x60 */
		0x00, 0x11, 0x3f, 0x1f, 0x7c, 0xf0, 0x21, 0x80,
		0x80, 0x80, 0x80, 0x20, 0x72, 0x00, 0x30, 0x11,
	/* :0x70 */
		0xc9, 0x68, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, FIRST_ACTIVE_LINE, LAST_ACTIVE_LINE & 0xff,
		SAA712x_reg7c, 0x00, 0x00, 0x00,
	}, saa7121_regs_pal[] = {
	/* :0x26 */
		0x00, 0x00,
		0x21, 0x1d, 0x00, 0x00, 0x00, 0x00,
	/* :0x2e XXX: read-only */
		0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	/* :0x38 */
	...
	/* :0x50 */
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x3f, 0x7D, 0xAF, 0x23, 0x35, 0x35,
	/* :0x60 */
		0x00, 0x02, 0x2F, 0xCB, 0x8A, 0x09, 0x2A, 0x80,
		0x80, 0x80, 0x80, 0x20, 0x86, 0x04, 0x20, 0x15,
	/* :0x70 */
		0xc9, 0x68, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x16, 0x36,
		SAA712x_reg7c | 0x40, 0x00, 0x00, 0x00,
	};
	...
	if (1 /* SAA7128 */) {
		...
		if (dev->video_type == SOLO_VO_FMT_TYPE_PAL)
			saa712x_write_regs(dev, saa7121_regs_pal, reg_start,
					sizeof(saa7121_regs_pal));
		else
			saa712x_write_regs(dev, saa7121_regs_ntsc, reg_start,
					sizeof(saa7121_regs_ntsc));
	}
}
